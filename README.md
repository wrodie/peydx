...
Multi-tenant church education and classroom presentation system with digital signage. Manage media, build programs, schedule content to screens, and play it back — online or offline.

The concept here is that the church (or other organisation) can run a local server (or potentially cloud host). They can then use inexpensive devices behind their TVs/screens to run their children's ministry content, classroom presentations, or digital signage.  
...
See [DEPLOY_CLIENT.md](./guides/DEPLOY_CLIENT.md) for complete setup instructions.
...
- [ARCHITECTURE.md](./guides/ARCHITECTURE.md) — System architecture, data flow, and component diagrams
- [DEPLOY_SERVER.md](./guides/DEPLOY_SERVER.md) — Production server deployment (Docker + Cloudflare Tunnel)
- [DEPLOY_CLIENT.md](./guides/DEPLOY_CLIENT.md) — Hardware player and browser device deployment
- [INTEGRATION.md](./guides/INTEGRATION.md) — External API
- [admin-guide.md](./guides/admin-guide.md) — Administrator reference guide
- [user-guide.md](./guides/user-guide.md) — Basic user workflow guide